...
const Login = () => {
    ...
    return (
        <div className="login-container d-flex">                                                                                        
            {/* Left Panel */}
            <div className="login-left bg-success text-white p-5 d-flex flex-column justify-content-center" style={{ width: '30%' }}>
                <div>
            ...
            <div className="login-right p-5 d-flex justify-content-center align-items-center" style={{ width: '70%' }}>
                <form className="login-form w-100" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center mt-4">
                        <p>Don't have an account? <Link to="/Registration" className="text-success">REGISTER</Link></p>
